...
def map_hub_credits(crse_attr_value):
    hub_credits = {'historical_context': False, 
...
def write_courses(courses):
    ...
    for course in courses:
        ...
        # Create or fetch HubCredits instance
        hub_credits_key = tuple(hub_credits_dict.items())  # Use a tuple to create a unique key
